...
Sionna frame BLER + ego fallback + lam=0 argmax as opv2v.py. Checks 3 pre-registered
predictions and writes results/main/step4_oracle_action_dist.csv.
...
def main():
    ...
    for sp in SPLITS:
        ...
        for ch in ('awgn', 'rayleigh'):
            for snr in SNR_GRID:
                ...
                # feasibility mask (label-only), identical to opv2v.py
                masked = eff.copy()
    ...
    print('wrote results/main/step4_oracle_action_dist.csv', out.shape)

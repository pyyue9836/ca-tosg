...
# results/baselines/importance_map_jscc/jscc_ap_f1.csv (already scored). Reads only frozen inputs (comp/ego npz + v3 GT +
...
Output: results/baselines/importance_map_jscc/channel_codec_ap.csv (long form: channel, codec, snr_db, ap50).
"""
...
P1 = os.path.join(REPO, 'peiyi_work/paper1'); GS = os.path.join(P1, 'gs_rerun'); OUT = os.path.join(P1, 'results/baselines/importance_map_jscc')

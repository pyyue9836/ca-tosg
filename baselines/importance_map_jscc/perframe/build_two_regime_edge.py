...
Outputs: results/baselines/importance_map_jscc/two_regime_edge.csv (appends per channel,split,regime).
"""
import os, sys
...
JSCC_DIR = os.path.join(P1, 'gs_rerun/jscc_v3'); OUT = os.path.join(P1, 'results/baselines/importance_map_jscc')

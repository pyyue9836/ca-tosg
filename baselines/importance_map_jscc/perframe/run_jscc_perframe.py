...
For each SNR we:
  ...
  3. run baselines/importance_map_jscc/inference_subset.py --save_npy (dumps per-frame pred/gt .npy),
...
# the learned stage2 checkpoints live on the H: drive (registered in docs/data_manifest.md, md5

...
$RUN projects/ca_tosg/evaluation/figures/plot_paper_figures.py --channel awgn \
...
$RUN projects/ca_tosg/evaluation/figures/plot_paper_figures.py --channel rayleigh \
...
$RUN projects/ca_tosg/evaluation/figures/plot_paper_figures.py --channel ofdm \

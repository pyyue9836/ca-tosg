...
actually reported in the paper are the epoch-50 global-sort AP in results/baselines/where2comm.csv,
produced by the OpenCOOD global-sort eval recorded in that CSV's `source` column (eval yaml) --
see results/provenance/where2comm_ap_PROVENANCE.txt. Do not run this script for the paper's Where2comm row;

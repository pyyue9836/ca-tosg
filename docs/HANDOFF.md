...
**Branch** `p1-phy-rebuild` · **written at** `a635921` · **recovery tag** `pre-p0-corrigendum` (the pre-correction state; nothing before it is quotable).
...
2. **Where2comm budget-matched rerun: plan v2 written, awaiting cost approval.**
   `docs/where2comm_rerun_plan_v2.md` (R50) supersedes the archived R21-B plan and is current with

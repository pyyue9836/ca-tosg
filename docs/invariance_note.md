...
(a) WHERE the payload dict enters the utility. policy_200seed.py:127 `obj = eff - lam*PAYVEC + mask`
...
The DEPLOYED selector itself (train_rf_v3.py) imitates lambda=0 masked-argmax oracle labels -> payload-

...
|---|---|---|---|---|---|---|---|---|
| 0.10 | `selector_B010` | #2 | 7 / 86 | 0.05 | 18.0 dB | 10 | 2 | `123ad7d3bace28c1…` |
| 0.20 | `selector_B020` | #1 | 0 / 99 | 0.02 | 12.0 dB | 10 | 2 | `db2322f82c1ae509…` |
| 0.30 | `selector_B030` | #56 | 0 / 112 | 0.0 | 8.0 dB | None | 2 | `ef5f8bc7df639402…` |
...
|---|---|---|---|---|---|---|
| 0.10 | 0.8555 | 0.8783 | 0.03276 | 0.8611 | 0.080803 | yes |
| 0.20 | 0.8606 | 0.8807 | 0.188792 | 0.8646 | 0.150158 | yes |
| 0.30 | 0.8622 | 0.884 | 0.262262 | 0.8662 | 0.201607 | yes |

## Per-class behaviour (frozen, validate)

| budget | | precision | recall | F1 | support |
|---|---|---|---|---|---|
| 0.10 | **E** | 0.9892 | 0.7244 | 0.8364 | 635 |
|  | **L** | 0.9566 | 0.9981 | 0.9769 | 38834 |
|  | **F** | 0.972 | 0.6113 | 0.7506 | 4091 |
| 0.20 | **E** | 0.9918 | 0.8043 | 0.8883 | 603 |
|  | **L** | 0.9655 | 0.9964 | 0.9807 | 36211 |
|  | **F** | 0.9758 | 0.8246 | 0.8939 | 6746 |
| 0.30 | **E** | 1.0 | 1.0 | 1.0 | 529 |
|  | **L** | 0.9994 | 1.0 | 0.9997 | 34988 |
|  | **F** | 1.0 | 0.9974 | 0.9987 | 8043 |

## Inputs pinned by the freeze

| input | file | hash |
|---|---|---|
| `train_grid` | `data/p2/p2_grid_validate.csv` | `ba6dc291858f71ff…` |
| `cue_source` | `data/p2/dataset_validate_n1.csv` | `21d3052857424505…` |
| `bler_table` | `results/channel/bler_sionna.csv` | `be3f5e1278ddda6e…` |
| `folds_csv` | `results/manifests/validate_loso_folds.csv` | `c706098bdb1b8568…` |
| `walk_B010` | `results/manifests/candidate_walk_B010.csv` | `813448808e585237…` |
| `walk_B020` | `results/manifests/candidate_walk_B020.csv` | `904a369504eb057d…` |
| `walk_B030` | `results/manifests/candidate_walk_B030.csv` | `9e849885271fe99c…` |

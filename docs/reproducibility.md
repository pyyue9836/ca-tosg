...
| 6 | verify and compile | `python tools/verify_results.py`, `python tests/test_compile.py` | 19 gate results, `main.pdf` (16 pp.), `supplementary.pdf` (9 pp.), `docs/compile_report.md` |

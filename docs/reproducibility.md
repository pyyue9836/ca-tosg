...
| 6 | verify and compile | `python tools/verify_results.py`, `python tests/test_compile.py` | 21 gate results, `main.pdf` (16 pp.), `supplementary.pdf` (12 pp.), `docs/compile_report.md` |
...
* **It does not affect the content tier.** All 13 content-tier checks run on the committed tree and

...
Future work includes multi-vehicle scheduling under shared bandwidth, extension to a Where2comm-style spatial confidence module inside the $C_q$ branches~\cite{hu2022where2comm}, and integration with spread-spectrum signalling for jamming resilience in safety-critical V2X scenarios.

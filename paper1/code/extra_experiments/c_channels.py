...
# Rician-fading output (results/robustness_rician.csv) was archived then REMOVED in P1.5 as
# convention-in-doubt, and must be regenerated in P2 under the current bler_sionna / ego-fallback /

...
selectors' validate numbers (p3_baseline_sanity.csv) for context. Descriptive only.

Output: results/p3_sensitivity/item3_variants.csv  (+ notes in PROVENANCE_p3.txt).
Run:  /path/to/env/python paper1/code/p2_dataprep/train_p3_variants.py
"""
import os
import sys
...
def main():
    ...
    print('wrote results/p3_sensitivity/item3_variants.csv (labeled variants, not deployed; validate-only)')

...
F_t^{C_q}  &= (1 - \mathrm{BLER}_q(\gamma_t,\text{ch}_t)) \cdot F_t^{C_q,\mathrm{clean}} + \mathrm{BLER}_q(\gamma_t,\text{ch}_t) \cdot F_t^{\mathrm{ego}}, \quad q \in \{16, 256\}, \label{eq:eff_C}
\end{align}

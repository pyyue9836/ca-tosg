...
| **JSCC per-frame decode boxes+scores+gts (36 = 3ch×2split×6SNR)** | `gs_rerun/jscc_v3/jscc_{ch}_{split}_snr{NN}.npz` | 36-npz set md5 `02b9187dc8e1005b` (288 MB) | `code/extra_experiments/jscc_perframe/jscc_sweep.py --mode sweep` | **~10 GPU-hours (full sweep)** | **PRESENT (36/36, survived the 2026-07-12 power outage)** |

...
efficiency, not raw accuracy; the threshold rule is a fully interpretable special case. In short, the SNR-threshold rule matches or slightly exceeds the RF in realised F1 but at higher payload, confirming that \emph{channel awareness is the dominant decision factor while the ego-side perception cues mainly improve bandwidth efficiency}.

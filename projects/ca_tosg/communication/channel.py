...
"""
SAME framework as ldpc_qam.py (Es/N0 axis, per-codeword-independent realisation, perfect CSI,
...
Output: results/channel/bler_sionna_ofdm.csv (channel='ofdm'); merged into bler_sionna.csv after review.
"""

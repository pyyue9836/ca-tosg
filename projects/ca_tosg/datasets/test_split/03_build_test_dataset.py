...
# any frozen paper number -- the test-split oracle dataset now comes from opv2v.py on the
# v3 datasets (bler_sionna frame-level, ego fallback, feasibility mask). Do not rerun for paper
# values; P2 regenerates under docs/experiment_protocol.md. NOT repointed to bler_sionna: incompatible schema

...
"""
Mirrors true_e2e_inference.py but on the OPV2V test split:
...
# RETIRED v2 selector. NOT a source of any frozen paper number -- the true-e2e AP on test now comes
# from true_e2e_global.py --split test (bler_sionna frame-level, global-sort). Do not rerun for
# paper values; P2 regenerates under docs/experiment_protocol.md. NOT repointed to bler_sionna: incompatible schema
# would break this codeword-level loader.

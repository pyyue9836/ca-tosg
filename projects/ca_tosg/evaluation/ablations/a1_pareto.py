...
frontier + policy points already produced (200-realisation averaged) by policy_200seed.py:
  results/policy/frontier_{split}.csv   (lambda, payload, f1, frac_C256/C16/L)
  results/main/pareto_points.csv      (Fixed L/C16/C256, oracle, clairvoyant, RF, tau, blind)
...
POL = os.path.join(P1, 'results/main'); FIGDIR = os.path.join(P1, 'paper/figures')

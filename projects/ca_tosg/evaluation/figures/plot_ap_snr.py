...
TRUE_E2E = _first_existing(
    os.path.join(P1, 'results/main/true_e2e_global_validate.csv'),  # v3: matches the item-7 section
    os.path.join(P1, 'results/main/true_e2e_global_validate.csv'),
...
JSCC_V3 = os.path.join(P1, 'results/baselines/importance_map_jscc/jscc_ap_f1.csv')            # JSCC baseline (has ap50 + ap70)
CODEC_V3 = os.path.join(P1, 'results/baselines/importance_map_jscc/channel_codec_ap_validate.csv')  # LDPC-16/256 baseline (ap50)

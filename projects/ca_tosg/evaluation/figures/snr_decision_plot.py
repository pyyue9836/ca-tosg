...
SEL = os.path.join(P1, 'results/main/true_e2e_global_validate.csv')  # deployed selector rho_L per SNR
ORC = os.path.join(P1, 'results/main/step4_oracle_action_dist.csv')             # oracle frac_{L,C16,C256} per SNR

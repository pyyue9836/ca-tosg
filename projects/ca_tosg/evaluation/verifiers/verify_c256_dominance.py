...
D = os.path.join(os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', '..', '..', '..')), 'data')
...
out.to_csv(os.path.join(os.path.dirname(D), 'results/sensitivity/c256_dominance_verify.csv'), index=False)

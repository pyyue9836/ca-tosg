...
RULES = [
    ...
    (r'^baselines/scomcp\.csv$',
     'python baselines/scomcp/perframe/run_scomcp_perframe.py',
     'SComCP reproduction, DESCRIPTIVE baseline; BOTH pre-registered fuses fired (SC-3) -- a '
     'scaffold finding, NOT a measurement of the method. Not for the baseline table.'),
    (r'^baselines/scomcp_perfect_channel_diagnostic\.csv$',
     'python baselines/scomcp/perframe/run_scomcp_perframe.py --channels perfect_comm',
     'SC-3 decisive diagnostic: a lossless channel gives the same output as 0 dB Rayleigh'),
    (r'^baselines/SCOMCP_FUSE_REPORT\.md$',

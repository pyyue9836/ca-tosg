...
| `../../docs/p2_prerequest_info_review.md` | decision information, decision object and decision timing in existing methods (P2-R27) — literature only, every quote verified verbatim |
| `results/lit/*.txt` | text extracted from each cited paper's PDF, archived so quotes stay re-checkable |

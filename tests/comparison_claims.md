...
| threshold-F1-B020 | RF | tau_nominal | < | F1 | test | 0.20 | `attains the marginally higher realised F1 at \emph{every} budget` |
...
| feasible-F1-B020 | RF | tau_feasible | > | F1 | test | 0.20 | `ahead by $+0.00067$ at $B_{\max}=0.20$` |
